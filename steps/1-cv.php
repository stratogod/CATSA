...
<p>The CV is a summary of your educational and academic background. It will be concise, yet thorough. Your education and accomplishments as well as your professional history, experiences, research, presentations, publications, honors and awards will be listed in the CV. It may also include additional information. Once you have a CV, you will continue adding to it throughout your career. Starting your CV early in your medical education will become very useful when you begin the residency application process as you begin entering information into the Electronic Residency Application Service (ERAS) the CV will help. ERAS will generate a basic CV automatically using the information you entered. </p>

<p>You’ll need a professional CV for these activities:</p>

<p>
<ul>
<li>M1 Summer Fellowship Application</li>
<li>Letter of Recommendation Providers</li>
<li>Integrated Residency Application</li>
<li>Visiting Student Application Service (VSAS)</li>
<li>Interview Day</li>
</ul>
</p>
...
<? if($userRole == "student") { ?>
<p><a href="/documents.php"><img src="/images/share.jpg" style="width: 17px;" alt="Share with adviser" /><span style="position: relative; top: -4px; left: 6px;">Share CV with Advisor</span></a></p>
<br />
<? } ?>
